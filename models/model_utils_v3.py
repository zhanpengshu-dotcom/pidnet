...
class ODConv2d(nn.Module):
    ...
    Enables input-dependent kernel adaptation for different tower materials (cement, angle steel).
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, reduction=16):
        ...
        # Spatial attention: (N, k*k) -> 逐核位置缩放
        ...
        # Input channel attention: (N, C_in) -> 逐输入通道缩放
        ...
        # Output channel attention: (N, C_out) -> 逐输出通道缩放
